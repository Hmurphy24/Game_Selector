...
def game_selector_hub():
    ...
    while True:
        ...
        user_game_input = input('Enter the game you would like to play, or if you need help type "Help" if you want me state the different games. Or if you don\'t want to play anything type "Quit" ')
